...
if __name__ == "__main__":
    ...
    # model = MLPClassifier(sovler = 'sgd', alpha = 0.00001, activation = 'relu', max_iter = 100, verbose = 1)
    # model = PassiveAggressiveClassifier(max_iter = 100, loss = 'hinge')
    # model = svm.SVC(kernel = 'rbf', max_iter -1, verbose = True)
